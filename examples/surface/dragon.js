...
Dragon.prototype = {
    ...
    init: function (gl,dragon) {
        ...
        that.indexBuffer.numItems = that.indicesPoint.length / that.indexBuffer.itemSize;
        ...
        gl.bufferData(gl.ELEMENT_ARRAY_BUFFER, new Uint32Array(that.indicesPoint), gl.STATIC_DRAW);
    ...
    draw: function (gl, prog) {
        ...
        gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, that.indexBuffer);
        gl.drawElements(gl.POINTS, that.indexBuffer.numItems, gl.UNSIGNED_INT, 0);
