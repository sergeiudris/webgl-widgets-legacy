...
Triangle.prototype = {
    ...
    draw: function (gl, prog) {
        ...
        gl.vertexAttribPointer(prog.aVertexPosition, that.positionBuffer.itemSize, gl.FLOAT, false, 4 * that.positionBuffer.itemSize, 0);//4 * that.positionBuffer.itemSize
        gl.bindBuffer(gl.ARRAY_BUFFER, that.colorBuffer);
        gl.vertexAttribPointer(prog.aVertexColor, that.colorBuffer.itemSize, gl.FLOAT, false, 4 * that.colorBuffer.itemSize, 0);//4 * that.colorBuffer.itemSize
